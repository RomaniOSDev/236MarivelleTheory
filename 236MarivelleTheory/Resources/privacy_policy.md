...
• Wind and forecast data are fetched from Open-Meteo (open-meteo.com) using city names you enter manually. Only the city search query and coordinates are sent to retrieve weather — no personal identifiers are included.
